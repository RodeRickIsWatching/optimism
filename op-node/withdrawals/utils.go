...
func FindLatestGame(ctx context.Context, disputeGameFactoryContract *bindings.DisputeGameFactoryCaller, optimismPortal2Contract *bindings.OptimismPortal2Caller) (*bindings.IDisputeGameFactoryGameSearchResult, error) {
